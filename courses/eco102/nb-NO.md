...
![bilde](assets/fr/077.webp)
![bilde](assets/fr/078.webp)
...
Videre eksisterer ikke Staten i seg selv; det er bare menn som utgjør Staten, som styrer, administrerer, som lever av Staten direkte eller indirekte. Derfor er mennene som administrerer Staten som andre; de søker å tilfredsstille sine personlige interesser.

![image](assets/fr/133.webp)

Og siden Statens handling er rent omfordelende, er den underlagt presset fra spesielle interessegrupper. Faktisk har visse spesielle interessegrupper forstått at det var lettere å tjene penger gjennom politisk engasjement enn gjennom produktive atferder. De søker å stjele andres penger under dekke av Staten, og undergraver markedets produksjonskapasitet gjennom multiplisering av lover, skatter og byråkratiske begrensninger.

![image](assets/fr/134.webp)

Med andre ord forfølger Staten kun klientelistiske mål, og begrepet om allmenninteressen er uten mening. Enhver gevinst oppnådd av noen er på bekostning av andre: det er ikke et nullsumspill, men et negativt sumspill.
Bastiat forutser dermed, et århundre i forveien, analysene av det politiske markedets fungering som ville dukke opp på slutten av 1950-tallet med den såkalte Public Choice-skolen til James Buchanan, Nobelprisvinner i økonomi, og hans kollega Gordon Tullock.
![image](assets/fr/135.webp)
![image](assets/fr/136.webp)

Dessuten hevder Bastiat at Staten ikke har noen rettigheter som ikke først preeksisterer i individet. Hvorfor har Staten retten til å garantere, selv med makt, eiendommen til hver enkelt? Rett og slett fordi denne retten preeksisterer i individet. Man kan ikke nekte individer retten til selvforsvar, retten til å bruke makt om nødvendig for å avverge angrep mot deres personer, deres fakulteter og deres eiendommer. Denne naturlige retten til selvforsvar, som bor i alle borgere, kan ta en kollektiv form og legitimere felles kraft.

Derfor, for å vite om Staten er legitimt investert med en rett, må man spørre om denne retten bor i individet i kraft av deres organisasjon og i fravær av enhver regjering.

Det er derfor Staten ikke under noen omstendigheter kan krenke naturlige rettigheter; den må tvert imot garantere dem.

![image](assets/fr/137.webp)
Den sikrer Sikkerhet, både internt og eksternt, og Rettferdighet. Den kan være sterk og effektiv innenfor sitt domene. Men loven kan ikke trå utenfor denne svært strenge rollen fordi den da blir et instrument for plyndring fra noen til fordel for andre. Når Loven er fordreid, fungerer den som et instrument for urettferdighet. Fordreiningen av loven fører alltid til plyndring, som vi har sett i det forrige kurset. Det er umiddelbart, automatisk, uunngåelig og sikkert. Å ta loven ut av sitt domene kan bare krenke naturlige rettigheter. Sivilsamfunnet blir da fratatt sin makt (naturlige institusjoner, kontrakter, utvekslinger, foreninger) til fordel for statsstyring, det vil si teknokratisk og byråkratisk.
![bilde](assets/fr/138.webp)

Som et resultat er de eneste legitime offentlige tjenestene til en stat ifølge Bastiat tre i antall: militæret, politiet og rettsvesenet. Med andre ord, staten må sikre den interne og eksterne beskyttelsen av individer, deres frihet og deres eiendom. Det er derfor normalt at alle bidrar til denne beskyttelsen. Imidlertid, utover disse legitime funksjonene, er enhver annen bidrag til en annen tjeneste levert av staten underlagt granskning.

> Utenfor denne sirkelen skriver Bastiat, religion, utdanning, forening, arbeid, utvekslinger, alt tilhører domenet til privat aktivitet, under øyet til offentlig myndighet, som bare burde ha en oppgave med overvåking og undertrykkelse.

Når det gjelder offentlige tjenester, uttaler han et enkelt prinsipp:
Hvis du vil opprette en funksjon, bevise dens nytte. Demonstrer at den er verdt tjenestene den gir, tilsvarende det den koster. Derfor konkluderer han, er det rimelig å betro til offentlig sektor bare det som privat sektor absolutt ikke kan oppnå.

Oppsummert, når en regjering overskrider sitt oppdrag med å forsvare folk og eiendom, oppmuntrer den interessegrupper til å søke privilegier og påvirke makt for å oppnå fordeler på bekostning av skattebetalere og forbrukere.

> Staten er den store fiksjonen gjennom hvilken alle streber etter å leve på bekostning av alle andre.

Skrev Frédéric Bastiat i en kort pamflett med tittelen Staten.

![bilde](assets/fr/139.webp)
...
Med det 20. århundret forsvant kunnskapen og populariteten til Bastiat. Han ble ikke lenger nevnt i økonomiske lærebøker. Det ville ikke være før slutten av andre verdenskrig at en fornyet interesse for ideene om frihet, så tydelig glemt med Roosevelt og de totalitære regimene i Europa, ville dukke opp. En av arkitektene for denne gjenopplivingen var den østerrikske økonomen Ludwig von Mises, en av de mange europeiske intellektuelle som flyktet fra Europa gjennom Spania og Portugal for å nå Amerika.
Bosatt i New York i 1943, organiserte Mises seminarer som tiltrakk seg bemerkelsesverdige sinn: George Stigler, Milton Friedman, begge fremtidige Nobelprisvinnere, og Murray Rothbard, den gang en student ved Columbia. Det var under disse seminarene han for første gang snakket om Bastiat som en av de viktigste referansene for klassisk liberalisme. Han presenterte for sine lyttere Bastiats pamfletter, "The Law" og "The State", som ennå ikke var oversatt til engelsk. I 1953 ville en av seminardeltakerne, Leonard Read, få "The Law" av Bastiat oversatt til engelsk og tok på seg oppgaven med å distribuere boken over hele landet gjennom sin stiftelse: Foundation for Economic Education.
![bilde](assets/fr/140.webp)
Men den som også ville popularisere tesene til Frédéric Bastiat var en økonomisk spaltist for New York Times, Henry Hazlitt, i en liten bok kalt: "Economics in One Lesson," publisert i 1946. Med utgangspunkt i Bastiats ideer, sikter han til å demonstrere at problemet med statlige økonomiske løsninger er deres manglende evne til å vurdere deres katastrofale langsiktige konsekvenser.
![bilde](assets/fr/141.webp)

Hazlitt begynner sin bok med å gjenfortelle Bastiats historie om det knuste vinduet. Han oppsummerer historien i en enkel og unik lekse:

> Økonomiens kunst består i å se ikke bare på de umiddelbare, men også på de lengre effektene av enhver handling eller politikk; den består i å spore konsekvensene av den politikken ikke bare for én gruppe, men for alle grupper.

Hazlitt anvender deretter denne leksen på et bredt spekter av økonomiske problemer: kontroll av husleie, lover om minstelønn, de antatte fordelene med krig, offentlige arbeider og budsjettunderskudd, monetær inflasjon, toll, og til slutt sparing.

Bastiat var en av Ronald Reagans favorittøkonomer, lenge før han ble valgt til president. Det er mindre kjent, men i åtte år jobbet Reagan for General Electric-selskapet som vert for dets TV-show på CBS, og som ansvarlig for selskapets ansattopplæring. Hans opplæringsprogram var bygget rundt innføringstekster til markedsøkonomien. De valgte verkene var de av to østerrikere, Hayek og Mises, to engelskmenn, Cobden og Bright, og en franskmann, Frédéric Bastiat.

Leksjonen som Reagan lærte sine ansatte, i tråd med Bastiat, er at det ikke finnes noen større myte enn den om å stimulere vekst og sysselsetting gjennom offentlige utgifter.
![bilde](assets/fr/142.webp)

Det var spesielt John Maynard Keynes som foreslo at offentlige utgifter økte produksjonen på grunn av en multiplikator: hvis regjeringen bygger en bro, vil arbeiderne på den broen kunne kjøpe brød, deretter kan bakeren kjøpe sko, og så videre. Hvis privat industri er i tilbakegang, kan det avhjelpes med store arbeider. Hvis det er arbeidsledighet, kan staten skape offentlige jobber.
Men som Bastiat treffende demonstrerte, har statlig intervensjon perverse effekter som ikke ses. Bare en god økonom er i stand til å forutse dem. La oss ta et eksempel: Det er en illusjon å tro at regjeringen kan "skape jobber" fordi for hver offentlig jobb som skapes, ødelegger den en jobb i markedet. Faktisk betales offentlige jobber av skatter. Offentlige jobber skapes ikke; de oppfattes. Hver krone brukt av staten må nødvendigvis oppnås gjennom en krone i skatt eller gjeld.
![bilde](assets/fr/143.webp)
