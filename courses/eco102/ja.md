...
1846年2月23日、ボルドーで最初の会合が開かれ、その際にボルドー自由貿易協会が設立されました。やがて、この運動はフランス全土に広がりました。パリでは、経済学者協会のメンバーの間に初期の核が形成され、その後、代議士、産業家、商人が加わりました。マルセイユ、リヨン、ル・アーヴルにも重要なグループが形成されました。![image](assets/fr/005.webp)
